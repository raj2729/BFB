...
const makePhoneCall = asyncHandler(async (req, res) => {
  try {
    client.calls
      .create({
        twiml:
          "<Response><Say>This is a reminder call to the ngo from the Bangalore Food bank. Thank you for your contribution. Kindly call back for monthly verification. Good bye. Have a nice day.</Say></Response>",
        to: "+917977757495",
        from: "+14582258918",
      })
...
const sendProgressReport = async (req, res) => {
  ...
  setTimeout(async function () {
    ...
    output =
      output +
      "<p><strong>Regards</strong></p><p><strong>Team BFB</strong></p>";
    ...
    let transporter = nodemailer.createTransport({
      ...
      auth: {
        user: `teamfullstacksimplified@gmail.com`,
        pass: `fsspassword123`,
      },
      // If on localhost
      tls: {
    ...
    let mailOptions = {
      from: `teamfullstacksimplified@gmail.com`,
